...
[VolumeComponentMenu("Post-processing Custom/test")]
[VolumeRequiresRendererFeatures(typeof(testRendererFeature))]
[SupportedOnRenderPipeline(typeof(UniversalRenderPipelineAsset))]
public sealed class testVolumeComponent : VolumeComponent, IPostProcessComponent
{
    public testVolumeComponent()
    {
        displayName = "test";
    }
