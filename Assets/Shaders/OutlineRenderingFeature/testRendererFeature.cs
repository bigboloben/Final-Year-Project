...
public sealed class testRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        testVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<testVolumeComponent>();
